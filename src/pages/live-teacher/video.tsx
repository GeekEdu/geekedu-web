...
import { AttachDialog } from '../live/components/attach-dialog'
      ...
      <div className={styles.content}>
        <div className={styles.navheader}>
          <div className={styles.top}>
            ...
            <span onClick={() => goDetail()}>这是课程标题</span>
            <button className={styles.button}>结束直播</button>
          </div>
        </div>
            ...
            <div className={styles['live-box']}>
              <div className={styles['live-item']}>
                ...
                <div className={styles['live-item-title']}>
                  ...
                  <span className={styles.name}>这是课程视频标题</span>
