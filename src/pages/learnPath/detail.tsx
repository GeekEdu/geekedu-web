...
import { miaosha, path, tuangou } from '../../api/index'
import {
  MiaoshaDialog,
  MiaoshaList,
  ThumbBar,
      ...
      <div className={styles['book-info']}>
        <div className={styles['book-info-box']}>
          ...
          <div className={styles.info}>
            ...
            <p className={styles.desc}>{learn.intro}</p>
            {!loading && (
            ...
            {steps.map((item: any) => (
              <div key={item.id} className={styles['step-item']}>
                ...
                <div className={styles['right-item']}>
                  ...
                  <div className={styles['step-desc']}>{item.intro}</div>
