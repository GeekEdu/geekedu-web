...
import { Button, Dropdown, Input, Menu, Skeleton, message } from 'antd'
...
export function Header() {
  ...
  useEffect(() => {
    if (pathname.includes('/courses/'))
      ...
      setCurrent('/book')
    else if (pathname.includes('/learnPath/'))
      setCurrent('/learnPath')
    else if (pathname.includes('/wenda/'))
      setCurrent('/wenda')
    else if (pathname.includes('/exam/papers/'))
      setCurrent('/exam/papers')
    else if (pathname.includes('/exam/mockpaper/'))
      setCurrent('/exam/mockpaper')
    else if (pathname.includes('/exam/practice/'))
  ...
  const checkNav: MenuProps['onClick'] = (e: any) => {
    const blank = e.item.props.blank
